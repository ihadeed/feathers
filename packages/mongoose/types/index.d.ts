...
import { Params, Paginated, Id, NullableId, Hook } from '@ihadeed/feathers';
import { AdapterService, ServiceOptions, InternalServiceMethods } from '@ihadeed/adapter-commons';
