...
import { Hook, HookContext, Params, Query, Paginated, Application } from '@ihadeed/feathers';
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#ActOnDefault}
 */
export function actOnDefault(...hooks: Hook[]): Hook;

/**
 * Runs a series of hooks which mutate context.dispatch.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#ActOnDispatch}
 */
export function actOnDispatch(...hooks: Hook[]): Hook;

/**
 * Make changes to data or result items. Very flexible.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#AlterItems}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Cache}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#CallingParams}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#CallingParamsDefaults}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#CheckContext}
 */
 ...
 * Restrict a hook to run for certain methods and method types. (Utility function.)
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#CheckContextIf}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Combine}
 */
export function combine(...hooks: Hook[]): Hook;

/**
 * Display the current hook context for debugging.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Debug}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#DeleteByDot}
 */
export function deleteByDot(object: any, path: string): void;

/**
 * Remove records and properties created by the populate hook.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#DePopulate}
 */
export function dePopulate(): Hook;

// todo: dialablePhoneNumber docs
/**
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#DialablePhoneNumber}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#DisableMultiItemChange}
 */
export function disableMultiItemChange(): Hook;

/**
 * Prevents multi-item creates.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#DisableMultiItemCreate}
 */
export function disableMultiItemCreate(): Hook;

/**
 * Disables pagination when query.$limit is -1 or '-1'.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#DisablePagination}
 */
export function disablePagination(): Hook;

/**
 * Prevents access to a service method completely or for specific transports.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Disallow}
 */
export function disallow(...transports: TransportName[]): Hook;

/**
 * Delete certain fields from the record(s).
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Discard}
 */
export function discard(...fieldNames: string[]): Hook;

/**
 * Delete certain fields from the query object.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#DiscardQuery}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#ExistsByDot}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#GetByDot}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#GetItems}
 */
export function getItems(context: HookContext): any; // any[] | any | undefined;

/**
 * Check which transport provided the service call.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#IsProvider}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Keep}
 */
export function keep(...fieldNames: string[]): Hook;

/**
 * Keep certain fields in a nested array inside the record(s), deleting the rest.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#KeepInArray}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#KeepQuery}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#KeepQueryInArray}
 */
export function keepQueryInArray(arrayName: string, fieldNames: string[]): Hook;

/**
 * Convert certain field values to lower case.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#LowerCase}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#MakeCallingParams}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#MongoKeys}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#ParamsForServer}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#ParamsFromClient}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Populate}
 */
export function populate(options: PopulateOptions): Hook;

/**
 * Prevent patch service calls from changing certain fields.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#PreventChanges}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#ReplaceItems}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Required}
 */
export function required(...fieldNames: string[]): Hook;

/**
 * Let's you call a hook right after the service call. (Utility function.)
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#RunHook}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#RunParallel}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Serialize}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#SetByDot}
 */
export function setByDot(object: object, path: string, value: any): void;

/**
 * Create/update certain fields to the current date-time.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#SetNow}
 */
export function setNow(...fieldNames: string[]): Hook;

/**
 * Fix slugs in URL, e.g. /stores/:storeId.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#SetSlug}
 */
...
/**
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#SequelizeConvert}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Sifter}
 */
export function sifter(siftFunc: SyncContextFunction<(item: any) => boolean>): Hook;

/**
 * Conditionally skip running all remaining hooks.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#SkipRemainingHooks}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#SoftDelete2}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#StashBefore}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Traverse}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Validate}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#ValidateSchema}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#IffElse}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Iff}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Unless}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Some}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Every}
 */
export function every(...predicates: PredicateFn[]): AsyncPredicateFn;

/**
 * Negate a sync or async predicate function.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#IsNot}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#CallbackToPromise}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Client}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Pluck}
 */
export function pluck(...args: any[]): any;

/**
 * @deprecated Deprecated pluckQuery in favor of keepQuery for naming consistency.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#PluckQuery}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#PromiseToCallback}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#RemoveQuery}
 */
export function removeQuery(...args: any[]): any;

/**
 * @deprecated Deprecated in favor of setNow.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#SetCreatedAt}
 */
export function setCreatedAt(...args: any[]): any;

/**
 * @deprecated Deprecated in favor of setNow.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#SetUpdatedAt}
 */
 ...
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#SoftDelete}
 */
export function softDelete(...args: any[]): any;

/**
 * @deprecated DEPRECATED. Use disallow instead.
 * {@link https://feathers-plus.github.io/v1/@ihadeed/hooks-common/index.html#Disable}
 */
